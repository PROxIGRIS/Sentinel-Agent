...
_hardware_fingerprint_result: dict[str, str] = {}
...
def _compute_hardware_fingerprint_async():
    ...
    try:
        ...
        _hardware_fingerprint_result["value"] = "unknown"
...
def get_hardware_fingerprint_blocking(timeout: float = 10.0) -> str:
    _hardware_fingerprint_ready.wait(timeout=timeout)
    return _hardware_fingerprint_result.get("value", "unknown")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if not vault.load() or not vault.get("ACCESS_TOKEN"):
            ...
            if seed_file.exists():
                ...
                try:
                    ...
                    while True:
                        status = vault.provision_via_license(seed_key, hostname, HARDWARE_UUID, get_hardware_fingerprint_blocking())
                        if status == "SUCCESS":
        ...
        validate_identity_integrity(vault, get_hardware_fingerprint_blocking())
