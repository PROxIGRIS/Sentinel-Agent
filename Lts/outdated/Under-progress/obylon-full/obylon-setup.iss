...
LicenseFile=C:\Sentinel-Agent\Lts\Under-progress\obylon-full\docs\License.rtf
OutputDir=C:\Sentinel-Agent\Lts\Under-progress\obylon-full\dist
OutputBaseFilename=obylon-setup
;SetupIconFile=C:\Sentinel-Agent\Lts\Under-progress\obylon-full\assets\icon.ico
...
[Files]
Source: "C:\Sentinel-Agent\Lts\Under-progress\obylon-full\dist\Obylon.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Sentinel-Agent\Lts\Under-progress\obylon-full\obylonc\obylonc.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Sentinel-Agent\Lts\Under-progress\obylon-full\rust\target\release\ObylonBroker.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Sentinel-Agent\Lts\Under-progress\obylon-full\rust\target\release\ObylonCore.exe"; DestDir: "{app}"; Flags: ignoreversion

[Run]
Filename: "schtasks.exe"; Parameters: "/create /tn ""ObylonAgent"" /tr ""\""{app}\ObylonBroker.exe\"""" /sc onstart /ru SYSTEM /rl HIGHEST /f"; Flags: runhidden
...
begin
  ...
  begin
    ...
    begin
      ...
      if Exec(ExpandConstant('{app}\obylonc.exe'), 'activate --key-file "' + TempKeyFile + '"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode) then
      begin
