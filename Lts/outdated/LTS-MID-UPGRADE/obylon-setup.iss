...
LicenseFile=C:\Sentinel-Agent\Lts\LTS-MID-UPGRADE\License.rtf
OutputDir=C:\Sentinel-Agent\Lts\LTS-MID-UPGRADE
OutputBaseFilename=obylon-setup
;SetupIconFile=C:\Sentinel-Agent\Lts\LTS-MID-UPGRADE\assets\icon.ico
...
[Files]
Source: "C:\Sentinel-Agent\Lts\LTS-MID-UPGRADE\dist\obylon.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Sentinel-Agent\Lts\LTS-MID-UPGRADE\dist\obylonc.exe"; DestDir: "{app}"; Flags: ignoreversion
