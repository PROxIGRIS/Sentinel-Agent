...
// This leaves room for the Brain's 15-second helper deadline to collect an
// explicit unavailable result. CommandContext terminates PowerShell on this
// deadline; callers must treat that as unavailable evidence, never as a clone.
